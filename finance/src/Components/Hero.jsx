    ...
    <div className='text-white'>
        <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <div className='flex justify-center items-center'>
                ...
                <ReactTyped className='md:text-4xl sm:text-4xl text-xl font-bold md:pl-4 pl-2' 
            ...
            <button className='bg-green-500 w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black cursor-pointer hover:bg-green-600'>Get Started</button>
        </div>
    </div>
  )
}
